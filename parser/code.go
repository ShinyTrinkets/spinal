...
// The "this file was generated by Trinkets" warning message
func codeGeneratedByMsg(lang string) string {
	cmt := CodeBlocks[lang].Comment
	return cmt + " THIS FILE IS GENERATED by Trinkets\n" +
...
func codeLangImports(front FrontMatter, lang string) (str string) {
	if lang == "js" {
		...
		str += "const trigger = require('../lib/triggers');\n"
	}
	return
}
